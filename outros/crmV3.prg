...
//Prod1
@ 07,06 get cProdDescricao1 picture "@!"        valid !empty(cProdDescricao1)
@ 07,27 get nProdValor1     picture "@e 999.99" valid nProdValor1>0
@ 07,34 get nProdQtd1       picture "@e 999"     Valid nProdQtd1>0
read
...
@ 07,38 say nSubtotal1  picture "@e 999,999.99"
@ 11,38 say nTotal      picture "@e 999,999.99" color cCorStrTotal

//Prod2
@ 08,06 get cProdDescricao2 picture "@!"        valid !empty(cProdDescricao2)
@ 08,27 get nProdValor2     picture "@e 999.99" valid nProdValor2>0
@ 08,34 get nProdQtd2       picture "@e 999"    Valid nProdQtd2>0
read
...
@ 08,38 say nSubtotal2  picture "@e 999,999.99"
@ 11,38 say nTotal      picture "@e 999,999.99" color cCorStrTotal

//Prod3
@ 09,06 get cProdDescricao3 picture "@!"        valid !empty(cProdDescricao3)
@ 09,27 get nProdValor3     picture "@e 999.99" valid nProdValor3>0
@ 09,34 get nProdQtd3       picture "@e 999"    valid nProdQtd3>0
read
...
@ 09,38 say nSubtotal3  picture "@e 999,999.99"
@ 11,38 say nTotal      picture "@e 999,999.99" color cCorStrTotal
