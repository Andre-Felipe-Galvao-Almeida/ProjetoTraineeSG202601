...
@ 05,13 get cNomeAluno        picture "@!"         valid !empty(cNomeAluno)
@ 06,13 get cCurso            picture "@!"         valid !empty(cCurso)
@ 07,13 get nSerie            picture "9"          valid (nSerie>=1 .and. nSerie<=8)
@ 08,13 get nValorMensalidade picture "@e 9999.99" valid nValorMensalidade > 0
read
...
if !(cMotivoReprovacao01 == cAprovado)
   @ 12,01 say "+R$"
   @ 12,05 say transform(nValorMensalidade*0.2,"@e 999.99")
endif

if !(cMotivoReprovacao02 == cAprovado)
   @ 17,01 say "+R$"
   @ 17,05 say transform(nValorMensalidade*0.2,"@e 999.99")
endif

if !(cMotivoReprovacao03 == cAprovado)
   @ 22,01 say "+R$"
   @ 22,05 say transform(nValorMensalidade*0.2,"@e 999.99")
endif
...
@ 09,01 say "Disciplina 01:" + Alltrim(cNomeDisciplina01) + "(" +cMotivoReprovacao01 + ")"
@ 10,01 say "Nota: "         + Alltrim(Str(nMediaDisc1))    color cCorMediaDisc01
@ 11,01 say "Faltas: "       + Alltrim(Str(nFaltasDisc1))   color cCorFaltasDisc01

@ 14,01 say "Disciplina 02:" + Alltrim(cNomeDisciplina02) + "(" + cMotivoReprovacao02 + ")"
@ 15,01 say "Nota: "         + Alltrim(Str(nMediaDisc2))    color cCorMediaDisc02
@ 16,01 say "Faltas: "       + Alltrim(Str(nFaltasDisc2))   color cCorFaltasDisc02

@ 19,01 say "Disciplina 03:" + Alltrim(cNomeDisciplina03) +"(" + cMotivoReprovacao03 + ")"
@ 20,01 say "Nota: "         + Alltrim(Str(nMediaDisc3))    color cCorMediaDisc03
@ 21,01 say "Faltas: "       + Alltrim(Str(nFaltasDisc3))   color cCorFaltasDisc03
